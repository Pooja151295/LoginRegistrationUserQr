...
<body>
	...
	<div class="container mt-4">
		...
		<div class="card">
			...
			<div class="card-body">
			<img height="115" width="115" src="data:image/png;base64,<?php echo e(DNS2D::getBarcodePNG(' Your Name is '.$user->firstname.' '.$user->lastname.' And Email Id is '.$user->email,'QRCODE')); ?>" alt="barcode" />
				<!-- <?php echo QrCode::size(250)->generate($user->firstname); ?> -->
			</div>
		</div><br>
		<div class="card">
			<div class="card-header">
			...
			<div style="padding:17px;">
				<form name="editForm" id="editForm" method="POST" action="update">
					...
					<?php if(!empty($user->img)){ ?>
						<img class="profile" src= "<?php echo e(asset('img/').'/'.$user->img); ?>" width="100" height="100"><br><br>
					<?php }else{?>
					<img class="profile" src="<?php echo e(asset('img/avtar.jpg')); ?>" width="100" height="100"><br><br>
					<?php } ?>
		...
		<div class="card">
			...
			<div class="card-body">
				<form action="<?php echo e(url('users')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\AuthQr\resources\views/auth/dashboard.blade.php ENDPATH**/ ?>